...
if (!isNull(_injuredperson getVariable "healer") || {!isNull(_injuredperson getVariable "dragger")}) exitWith {[format ["%1 is being assisted.", name _injuredperson]] spawn tcb_fnc_showMessage};
