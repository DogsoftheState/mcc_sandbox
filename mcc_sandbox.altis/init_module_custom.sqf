...
mccPresets = [
	...
	,['Lock Vehicle', '_this addAction [format["<t color=""#F0F000"">Lock Vehicle</t>"], {(_this select 0) setVehicleLock "LOCKED"}, _this];']
	,['Unlock Vehicle', '_this addAction [format["<t color=""#F0F000"">Unlock Vehicle</t>"], {(_this select 0) setVehicleLock "UNLOCKED"}, _this];']
	,['======= Misc =======','']
